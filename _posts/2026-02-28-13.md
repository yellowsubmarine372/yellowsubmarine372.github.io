...
every time the agent makes a mistake, engineer the environment so it can't make the specific mistake the same way again
...
- Enforcing taste (the most harness engineering part..)
...
**Natural language**
- goals, roles, preferences, decision criteria, interpretations of exceptional situations

**Code-enforced**
- permissions, input schemas, state transitions, retry limits, approval workflows,
  sandboxing, testing, evaluation, validators, linters, logging, cost limits
